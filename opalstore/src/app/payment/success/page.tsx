    ...
    return (
      <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
        <div style={{ textAlign: "center" }}>
          <div style={{ width: "60px", height: "60px", border: "4px solid rgba(255,255,255,0.1)", borderTopColor: "#d4a855", borderRadius: "50%", animation: "spin 1s linear infinite", margin: "0 auto 20px" }}></div>
        ...
        <div style={{ background: "#161b22", borderRadius: "20px", border: "1px solid rgba(255,255,255,0.08)", padding: "24px", marginBottom: "24px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", padding: "12px 0" }}>
              ...
              <span style={{ color: "#d4a855", fontSize: "18px", fontWeight: "bold" }}>{new Intl.NumberFormat("id-ID", { style: "currency", currency: "IDR", minimumFractionDigits: 0 }).format(orderData?.totalAmount || 0)}</span>
            </div>
          </div>
        </div>
          ...
          {orderData?.outputType === "link" && (
            <div>
              ...
              <div style={{ background: "rgba(217,119,6,0.1)", border: "1px solid rgba(217,119,6,0.3)", borderRadius: "12px", padding: "16px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "12px" }}>
                <a href={orderData.outputValue} target="_blank" rel="noopener noreferrer" style={{ color: "#d4a855", fontSize: "14px", textDecoration: "none", wordBreak: "break-all", flex: 1 }}>{orderData.outputValue}</a>
                <button onClick={() => copyToClipboard(orderData.outputValue)} style={{ padding: "8px 16px", borderRadius: "8px", background: "rgba(217,119,6,0.2)", border: "1px solid rgba(217,119,6,0.3)", color: "#d4a855", fontSize: "12px", fontWeight: "600", cursor: "pointer", whiteSpace: "nowrap" }}>Salin</button>
              </div>
            </div>
          )}
