    ...
    return (
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center' }}>
          ...
          <Link href="/dashboard" style={{ color: '#d4aa7d', textDecoration: 'none' }}>Kembali ke Dashboard</Link>
        </div>
      </div>
    );
  }
          ...
          <div style={{ background: '#141414', borderRadius: '10px', border: '1px solid rgba(255,255,255,0.08)', padding: '16px' }}>
            ...
            <div style={{ display: 'flex', gap: '16px', marginBottom: '20px', padding: '16px', background: 'rgba(255,255,255,0.02)', borderRadius: '10px' }}>
              ...
              <div style={{ textAlign: 'right' }}>
                <p style={{ color: '#d4aa7d', fontSize: '18px', fontWeight: 'bold' }}>{formatPrice(displayPrice)}</p>
              </div>
            </div>
          </div>
              ...
              {[
                ...
                >
                  ...
                  <div style={{ 
                    ...
                    height: '20px', 
                    borderRadius: '50%', 
                    border: formData.paymentMethod === method.id ? '6px solid #d4aa7d' : '2px solid rgba(255,255,255,0.2)',
                    transition: 'all 0.2s',
                  }} />
                </button>
              ))}
