    ...
    <div style={{ minHeight: '100vh', padding: '24px 16px' }}>
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: '16px' }}>
          <Link href={`/dashboard/${product.slug}`} style={{ color: '#555555', fontSize: '14px', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '6px', marginBottom: '16px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '12px' }}>
          ...
          <div style={{ background: '#141414', borderRadius: '10px', border: '1px solid rgba(255,255,255,0.08)', padding: '16px' }}>
            ...
            <div style={{ display: 'flex', gap: '16px', marginBottom: '20px', padding: '16px', background: 'rgba(255,255,255,0.02)', borderRadius: '10px' }}>
              <div style={{ width: '48px', height: '48px', borderRadius: '10px', background: '#121212', overflow: 'hidden', flexShrink: 0 }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <p style={{ color: '#555555', fontSize: '13px' }}>{displayName}</p>
              </div>
              ...
              {[
                ...
                >
                  <div>
                    ...
                    <p style={{ color: '#555555', fontSize: '12px' }}>{method.desc}</p>
                  </div>
                  <div style={{ 
                    width: '20px', 
                    height: '20px', 
          ...
          <div style={{ background: '#141414', borderRadius: '10px', border: '1px solid rgba(255,255,255,0.08)', padding: '16px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
              <span style={{ color: '#555555', fontSize: '16px' }}>Total Pembayaran</span>
...
export default function CheckoutPage() {
  return (
    <Suspense fallback={<div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}><p style={{ color: '#555555' }}>Loading...</p></div>}>
      <CheckoutContent />
    </Suspense>
  );
}
