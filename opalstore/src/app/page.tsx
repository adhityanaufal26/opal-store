    ...
    <div className="min-h-screen">
      ...
      <section style={{ minHeight: "85vh", display: "flex", alignItems: "center" }}>
        <div className="max-w-4xl mx-auto text-center px-4">
          <div className="mb-6">
            <span style={{ display: "inline-block", padding: "6px 16px", fontSize: "13px", fontWeight: "500", borderRadius: "999px", border: "1px solid rgba(217,119,6,0.3)", background: "rgba(217,119,6,0.08)", color: "#e0b870", letterSpacing: "0.02em" }}>
          ...
          <h1 style={{ fontSize: "clamp(2.5rem, 6vw, 4.5rem)", fontWeight: "800", lineHeight: "1.1", marginBottom: "24px", letterSpacing: "-0.02em" }}>
            Akses AI Premium
            <br />
            <span style={{ color: "#e0b870" }}>Harga Terjangkau</span>
          </h1>
          ...
          <div style={{ display: "flex", justifyContent: "center" }}>
            <Link
              href="/dashboard"
              style={{ display: "inline-flex", alignItems: "center", gap: "8px", padding: "14px 32px", background: "#d4a855", color: "#fff", fontWeight: "600", borderRadius: "12px", fontSize: "15px", transition: "all 0.2s" }}
            >
              Lihat Produk
            </Link>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "32px" }}>
            {[
              ...
              <div key={i} style={{ textAlign: "center" }}>
                <div style={{ width: "48px", height: "48px", display: "flex", alignItems: "center", justifyContent: "center", background: "rgba(217,119,6,0.1)", color: "#e0b870", borderRadius: "12px", fontSize: "18px", fontWeight: "700", margin: "0 auto 16px" }}>
                  {step.num}
                </div>
