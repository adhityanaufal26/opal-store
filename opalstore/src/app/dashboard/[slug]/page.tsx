      ...
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: "16px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "12px", padding: "12px", background: "#141414", borderRadius: "12px", border: "1px solid rgba(255,255,255,0.06)" }}>
            <div style={{ width: "72px", height: "72px", borderRadius: "12px", background: "#1a1a1a", overflow: "hidden", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center" }}>
              <img src={product.image} alt={product.name} style={{ width: "56px", height: "56px", objectFit: "contain" }} />
            </div>
