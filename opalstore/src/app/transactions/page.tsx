      ...
      <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                color: filter === tab.id ? '#e0b870' : '#a1a1aa',
        ...
        {filtered.length > 0 ? (
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                    ...
                    {trx.status === 'pending' && (
                      <>
                        ...
                        <button onClick={() => handlePay(trx)} disabled={payingOrderId === trx.orderId} style={{ padding: '7px 14px', borderRadius: '8px', background: '#d4a855', color: '#fff', fontSize: '12px', fontWeight: '600', border: 'none', cursor: payingOrderId === trx.orderId ? 'not-allowed' : 'pointer', opacity: payingOrderId === trx.orderId ? 0.5 : 1 }}>
          ...
          <div style={{ background: '#141414', borderRadius: '10px', border: '1px solid rgba(255,255,255,0.06)', padding: '48px 24px', textAlign: 'center' }}>
            ...
            <Link href="/dashboard" style={{ display: 'inline-block', padding: '10px 20px', borderRadius: '10px', background: '#d4a855', color: '#fff', fontSize: '13px', fontWeight: '600', textDecoration: 'none' }}>
              Mulai Belanja
            </Link>
          </div>
        )}
