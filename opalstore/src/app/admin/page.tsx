              ...
              <div key={id} style={{ background: "#161b22", borderRadius: "16px", border: "1px solid rgba(255,255,255,0.08)", padding: "20px", display: "flex", gap: "16px", alignItems: "center", flexWrap: "wrap" }}>
                ...
                <div style={{ flex: 1, minWidth: "200px" }}>
                  ...
                  <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
                    <span style={{ padding: "4px 10px", borderRadius: "6px", background: "rgba(14,165,233,0.1)", color: "#0ea5e9", fontSize: "12px" }}>{product.variants?.length || 0} variant</span>
              ...
              <div style={{ padding: "24px" }}>
                ...
                <div style={{ marginBottom: "20px" }}>
                  ...
                  <div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
                    ...
                    <div>
                      ...
                      <button onClick={() => fileInputRef.current?.click()} disabled={uploading} style={{ padding: "10px 20px", borderRadius: "10px", border: "1px solid rgba(14,165,233,0.3)", background: "rgba(14,165,233,0.1)", color: "#0ea5e9", fontSize: "13px", fontWeight: "600", cursor: "pointer", marginBottom: "8px" }}>
                ...
                <div style={{ marginBottom: "20px" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "12px" }}>
                    ...
                    <button type="button" onClick={addVariant} style={{ padding: "6px 12px", borderRadius: "8px", border: "1px solid rgba(14,165,233,0.3)", background: "rgba(14,165,233,0.1)", color: "#0ea5e9", fontSize: "12px", cursor: "pointer" }}>+ Tambah Variant</button>
                  </div>
                ...
                <div style={{ marginBottom: "24px" }}>
                  <label style={{ display: "flex", alignItems: "center", gap: "12px", cursor: "pointer" }} onClick={() => setFormData({ ...formData, isActive: !formData.isActive })}>
                    <div style={{ width: "44px", height: "24px", borderRadius: "12px", background: formData.isActive ? "#0ea5e9" : "rgba(255,255,255,0.1)", position: "relative", cursor: "pointer", transition: "background 0.2s" }}>
