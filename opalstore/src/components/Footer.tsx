        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "40px" }}>
          ...
          <div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
              ...
              <a href="https://opalagent.ai" target="_blank" rel="noopener noreferrer" style={{ width: "36px", height: "36px", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", background: "rgba(255,255,255,0.04)", transition: "background 0.2s" }}>
