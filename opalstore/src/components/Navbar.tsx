        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/" className="flex items-center gap-3 group">
              <div className="w-9 h-9 gradient-bg rounded-xl flex items-center justify-center group-hover:scale-105 transition-transform">
              ...
              {user || session ? (
                <>
                  ...
                  <Link 
                    ...
                    style={{ color: isActive("/transactions") ? "#0ea5e9" : "rgba(255,255,255,0.5)" }}
                  >
                  ...
                  {isUserAdmin && (
                    <Link 
                      ...
                      style={{ color: pathname === "/admin" ? "#0ea5e9" : "rgba(255,255,255,0.5)" }}
                    >
