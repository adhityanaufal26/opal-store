            ...
            <div style={{ display: "none", alignItems: "center", gap: "12px" }} className="md:flex">
              {user || session ? (
                <>
                  <Link
                    href="/transactions"
                    style={{ display: "flex", alignItems: "center", gap: "8px", padding: "8px 12px", borderRadius: "10px", color: isActive("/transactions") ? "#3b82f6" : "#71717a", textDecoration: "none", transition: "color 0.2s", position: "relative" }}
                  >
                  ...
                  {isUserAdmin && (
                    <Link
                      href="/admin"
                      style={{ display: "flex", alignItems: "center", gap: "8px", padding: "8px 12px", borderRadius: "10px", color: pathname === "/admin" ? "#3b82f6" : "#71717a", textDecoration: "none", transition: "color 0.2s" }}
                    >
                  ...
                  <button onClick={() => setProfileModalOpen(true)} style={{ display: "flex", alignItems: "center", gap: "8px", padding: "8px 12px", borderRadius: "10px", background: "none", border: "none", cursor: "pointer", transition: "background 0.2s" }}>
                    {avatarUrl ? (
                      ...
                      <div style={{ width: "32px", height: "32px", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "14px", fontWeight: "700", color: "#fff", background: "#2563eb" }}>
                ...
                <>
                  ...
                  <Link href="/register" style={{ padding: "10px 20px", fontSize: "14px", fontWeight: "600", color: "#fff", background: "#2563eb", borderRadius: "10px", textDecoration: "none", transition: "all 0.2s" }}>
                    Daftar
                  </Link>
                </>
              )}
              ...
              <div style={{ paddingTop: "12px", borderTop: "1px solid rgba(255,255,255,0.06)", marginTop: "12px", display: "flex", flexDirection: "column", gap: "4px" }}>
                {user || session ? (
                  ...
                  <>
                    ...
                    <Link href="/register" onClick={() => setMobileMenuOpen(false)} style={{ display: "block", padding: "12px 16px", textAlign: "center", fontSize: "14px", fontWeight: "600", color: "#fff", background: "#2563eb", borderRadius: "10px", textDecoration: "none" }}>
                      Daftar
                    </Link>
                  </>
                )}
